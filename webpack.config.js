...
const graphicsConfig = {
  entry: {
    ...
    layout169Complemento: ['./src/graphics/scripts/layout16-9-complemento.js'],
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: 'layout16-9-Complemento.html',
      template: './src/graphics/layout16-9-complemento.html',
      chunks: ['layout169Complemento']
    }),
    new HtmlWebpackPlugin({
